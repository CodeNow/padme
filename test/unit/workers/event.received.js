...
describe('event.received worker unit test', () => {
  let testJob
  ...
  describe('methods', () => {
    ...
    describe('_sendMetricData', () => {
      ...
      it('should log and increment counter', (done) => {
        ...
        sinon.assert.calledWith(monitorDog.increment, 'event.received')
        done()
      })
    }) // end _sendMetricData
    ...
    describe('_publishEvent', () => {
      ...
      it('should log and publish event', (done) => {
        ...
        sinon.assert.calledWith(publisher.publishEvent, 'event.received', {
          id: '1234'
        })
        done()
      })
